...
Di dalam matematika, banyak teorema yang menyatakan bahwa *p*(*n*) benar untuk semua bilangan bulat positif *n*, yang dalam hal ini *p*(*n*) disebut juga fungsi proposisi. Contoh pertama, misalkan *p*(*n*) adalah proposisi yang menyatakan : "Jumlah bilangan bulat positif dari 1 sampai *n* adalah *n*